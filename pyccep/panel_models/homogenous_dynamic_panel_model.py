...
class HomogenousDynamicPanelModel:
    ...
    def preprocess_data(self):
        ...
        if  lim_rho == False:
            raise Exception("The current model is considered a static model. Please add a dynamic component. For a static model use: HomogenousPanelModel")
